...
import {  PencilLine, Star, Trash} from "lucide-preact";
import { dashboardCardsData } from "@/components/card/utils/card.data";
import Card from "@/components/card/card";
import OverviewChart from "@/components/overview-chart/chart";
import AvatarList from "@/components/avatar-list/avatar-list";

const DashboardPage = () => {
    const items = recentSalesData.map((sale) => ({
        id: sale.id,
        title: sale.name,
        subtitle: sale.email,
        image: sale.image,
